    ...
    data() {
      return {
        ...
        fileds:[
          ...
          {list:true,label:'作者',name:'authorName',type:'input'},
          ...
          {list:true,label:'定时时间',name:'publishTime',type:'input'},
          {list:true,label:'创建时间',name:'createdTime',type:'hidden',value:DateUtil.format13HH(new Date().getTime())},
          {list:true,label:'提交时间',name:'submitedTime',type:'hidden',value:DateUtil.format13HH(new Date().getTime())}
        ]
      }
    },
    mounted() {
